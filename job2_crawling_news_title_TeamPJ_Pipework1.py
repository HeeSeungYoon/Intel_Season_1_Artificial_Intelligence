# WebCrawlingNewsTitles in Politics
# Produced by Pipework .
...
for l in range(len(category)):
    ...
    if k % 10 ==0:
        ...
        df_titles.to_csv('D:/Workspace_Python_1/Workspace_PyCharm_1/Team1011_ForkClone_1/Crawling_data_Pipework_Politics1/crawling_data_{}_{}.csv'.format(l, k), index=False)
